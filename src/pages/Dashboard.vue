    ...
    <q-card class="q-mt-sm no-shadow" bordered>
      <q-card-section class="text-h6 q-pb-none">
        <q-item>
          ...
          <q-item-section>
            <q-item-label>
              <div class="text-h6">Liste des arrivées récentes</div>
            </q-item-label>
            <q-item-label
              caption
              class="text-black"
            >Monitoring Your products. Tracking sales, and shipping status here.</q-item-label>
          </q-item-section>
        </q-item>
      </q-card-section>
          ...
          <q-tab-panels v-model="tab" animated>
            ...
            <q-tab-panel name="message" class="q-pa-sm">
              <q-item v-for="msg in messages" :key="msg.id" clickable v-ripple>
                ...
                <q-item-section side>{{ msg.time }}</q-item-section>
              </q-item>
            </q-tab-panel>
            ...
            <q-scroll-area class="fit">
              <q-card class="my-card">
                ...
                <q-card-section>
                  ...
                  >Curabitur egestas consequat lorem, vel fermentum augue porta id.</div>
                </q-card-section>
